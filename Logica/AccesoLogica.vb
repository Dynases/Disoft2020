...
#Region "Zona"
    ...
    Public Shared Function L_ZonaCabecera_GeneralCompletoDistribucion(_Modo As Integer, id As Integer, Optional _Cadena As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        If _Modo = 0 Then
...
#Region "Metodos Guido"
    ...
    Public Shared Function L_ProductosPedido_GeneralNuevoStock2(_Modo As Integer, Optional _CatClie As String = "", Optional _alm As String = "", Optional Mayor0 As Boolean = True) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 81))
        _listParam.Add(New Datos.DParametro("@concep", _CatClie))
        _listParam.Add(New Datos.DParametro("@alm", _alm))
        _listParam.Add(New Datos.DParametro("@cantP", IIf(Mayor0 = True, 1, 0)))
    ...
    Public Shared Function L_VaciarStock() As DataTable
        Dim _Tabla As DataTable
...
#Region "Pedidos"
    ...
    Public Shared Function L_PedidoCabecera_General(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        Dim _Where As String
        If _Modo = 0 Then
            _Where = "oanumi=oanumi And ccnumi=oaccli And oazona=lanumi And cecon=2 And lazona=cenum And oaato1numi=oanumi And oaanumiprev=cbnumi"
        Else
            _Where = "oanumi=oanumi And ccnumi=oaccli And oazona=lanumi And cecon=2 And lazona=cenum And oaato1numi=oanumi And oaanumiprev=cbnumi" + _Cadena 'and oanumi not in (select ofnumiped from TO0014)
        End If
        _Tabla = D_Datos_Tabla("DISTINCT oanumi,oafdoc,oahora,cccod,ccdesc,ccdirec,cctelf1,cccat,cczona as oazona, cedesc,oaobs,oaobs2,oaest,cclat,cclongi,oaap,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi)>0,1,0 ) as reclamo,oapg,ccultvent,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi And oftip=1)>0,1,0 ) as tipoRecCliente,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi And oftip=2)>0,1,0 ) as tipoRecRepartidor, ccnumi, cceven, oaanumiprev, cbdesc, cast((select sum(obtotal )  from TO0011 where obnumi =oanumi) as decimal(18,2)) as monto ", "TO001,TC004,TC0051,TL001, TO001A, TC002 ", _Where + " order by oanumi")
        Return _Tabla
    End Function
    ...
    Public Shared Function L_PedidoCabecera_GeneralSoloRepartidor(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        Dim _Where As String
        If _Modo = 0 Then
            _Where = "oanumi=oanumi And ccnumi=oaccli And cczona=lanumi And cecon=2 And lazona=cenum And tc004.cczona = tl001.lanumi And tl001.lanumi = tl0012.lcnumi And oaato1numi=oanumi And oaanumiprev=cbnumi "
        Else
        ...
        _Tabla = D_Datos_Tabla("DISTINCT oanumi,oafdoc,oahora,cccod,ccdesc,ccdirec,cctelf1,cccat," _
                              ...
                              "TO001,TC004,TC0051,TL001,TL0012,TO001A, TC002",
                               _Where + " and oanumi not in (select ofnumiped from TO0014) order by oanumi")
        Return _Tabla
    End Function
    ...
    Public Shared Function L_VerificarPedidoConsolidado(_IdPedido As String) As DataTable
        ...
        Dim campos As String = "oanumi, ieconcti2, ieest,oaest"
    ...
    Public Shared Sub L_Pedido_ModififcarCredito(_numi As String, fecha As String, monto As Double)
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@oanumi", _numi))
        _listParam.Add(New Datos.DParametro("@fechapedido", fecha))
        _listParam.Add(New Datos.DParametro("@credito", monto))
        _listParam.Add(New Datos.DParametro("@oadusuario", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO001D", _listParam)
    ...
    Public Shared Function L_PedidoDetalle_GeneralNuevo(_Modo As Integer, Optional _idCabecera As String = "") As DataTable
        ...
        If _Modo = 0 Then
            _Where = " obnumi = obnumi"
        Else
            _Where = "obnumi=" + _idCabecera + " AND obcprod=canumi AND iacprod=obcprod and iaalm=1 and cauventa=cenum and cecon = 106"
        End If
        _Tabla = D_Datos_Tabla("obnumi,obcprod, cacod, cadesc,cedesc,obpcant,obpbase,obptot,obdesc,obtotal,obfamilia, obcampo1, iacant", "TO0011,TC001, TI001,TC0051", _Where)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_prGrabarTO001C(oanumi As Integer, chofer As Double) As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_prActualizarTO001C(oanumi As Integer, conciliacion As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@oanumi", oanumi))
        _listParam.Add(New Datos.DParametro("@nconci", conciliacion))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        ...
        Return _resultado
    End Function
    Public Shared Function ListarProductoxPedido(idPedido As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 36))
        _listParam.Add(New Datos.DParametro("@pedido", idPedido))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_fnObtenerZonaRepartidorDistribuidor(where As String) As DataTable
        ...
        Else
            where = where + " and pedido.oazona = B.lanumi " _
                    & " and b.lazona = c.cenum AND c.cecon = 2 " _
...
#Region "TC001 Productos"
    ...
    Public Shared Function L_fnProductoGrabar(ByRef numi As String, cod As String, desc As String, desc2 As String,
                                              ...
                                              peso As Integer, ubicacion As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@ubicacion", ubicacion))
...
#Region "Clientes"
    ...
    Public Shared Function L_fnGrabarCliente(ByRef numi As String, cod As String, desc As String, zona As String,
                                             ...
                                             jueves As Integer, viernes As Integer, sabado As Integer, domingo As Integer, dtimagenes As DataTable) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@TC004Imagenes", "", dtimagenes))
    ...
    Public Shared Function L_prCargarImagenesClienteAll() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnObtenerTiposdeCliente() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prCargarImagenesCliente(ProductoId As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 21))
        _listParam.Add(New Datos.DParametro("@numi", ProductoId))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_prJobDuplicados()
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerClienteEspecial(numi As String) As Integer
        ...
        _listParam.Add(New Datos.DParametro("@ccest", numi))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
...
#End Region
    ...
    Public Shared Function L_prReporteNotaVenta(Pedido As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 27))
        _listParam.Add(New Datos.DParametro("@numi", Pedido))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_Validartabla(_Nom As String, _Codigo As String, ByRef NTabla As String) As Integer
        ...
        If _Tabla.Rows.Count > 0 Then
            For Each reg As DataRow In _Tabla.Rows
                If _Nom = "TC004" Then
                    _where = _Tabla.Rows(0).Item("bbcdes") + " = " + _Codigo + "oaap = 1"
                Else
...
#Region "CATEGORIA DESCUENTOS PRECIOS"
    ...
    Public Shared Function L_Productos_Descuento(idTipo As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 20))
        _listParam.Add(New Datos.DParametro("@numi", idTipo))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TC001", _listParam)

        Return _Tabla
    End Function
    Public Shared Function L_Grabar_Descuento(dt As DataTable) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@TD0012", "", dt))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TD001", _listParam)
...
#Region "CATEGORIA COMISIONES"
    ...
    Public Shared Function L_fnActualizarEstadoComision(cod As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnGrabarComisiones(ByRef numi As String, codpro As String, comision As String, comisionRep As String, comisionMayVend As String, comisionMayRep As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@comisionRep", comisionRep))
        _listParam.Add(New Datos.DParametro("@comisionMayVend", comisionMayVend))
        _listParam.Add(New Datos.DParametro("@comisionMayRep", comisionMayRep))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_prReporteVentasVendedorUno(_fechaI As String, _FechaF As String, _codPrevendedor As String, _Proveedor As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasComisionTodosRep(_fechaI As String, _FechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 9))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasComisionTodosRep1(_fechaI As String, _FechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasComisionUnoRep(_fechaI As String, _FechaF As String, _codPrevendedor As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasComisionUnoRep1(_fechaI As String, _FechaF As String, _codPrevendedor As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1010))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@codRepartidor", _codPrevendedor))
        _Tabla = D_ProcedimientoConParam("sp_go_TC0014", _listParam)
...
#Region "Vistas"
    ...
    Shared Function L_VistaStockActual(Optional _where1 As String = "") As DataTable
        ...
        Dim campos As String = "canumi,cacod,cadesc,caest,iacprod,Sum(iacant) as iacant, caconv, cenum,cedesc,cadesc2 "
        _Tabla = D_Datos_Tabla(campos, "VR_stockActual", _Where + "group by canumi,cacod,cadesc,caest,iacprod, caconv, cenum,cedesc,cadesc2 order by cadesc")
        Return _Tabla
    End Function
...
#Region "Kardex de Inventario"
    ...
    Shared Function L_VistaKardexInventario2(cod As String, fIni As String, fFin As String, Optional sucursal As String = "", Optional nombre As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        ...
        If (cod.Equals("-1")) Then
            If nombre = "" Then
                _Where = "alm=" + sucursal + " and " + "cprod = " + cod + " And fdoc >= '" + fIni + "' And fdoc <= '" + fFin + "'"
            Else
                _Where = "alm=" + sucursal + " and " + "cprod = " + cod + " And fdoc >= '" + fIni + "' And fdoc <= '" + fFin + "' and nombreCliente = '" + nombre + "'"
            End If
    ...
    Shared Function L_VistaKardexInventarioTodo2(cod As String, Optional fFin As String = "", Optional sucursal As String = "", Optional nombre As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String = "alm=" + sucursal + " and " + "cprod = " + cod + IIf(fFin.Equals(""), "", " And fdoc < '" + fFin + "' and nombreCliente = '" + nombre + "'")
        If nombre = "" Then
            _Where = "alm=" + sucursal + " and " + "cprod = " + cod + IIf(fFin.Equals(""), "", " And fdoc < '" + fFin + "'")
        Else
            _Where = "alm=" + sucursal + " and " + "cprod = " + cod + IIf(fFin.Equals(""), "", " And fdoc < '" + fFin + "' and nombreCliente = '" + nombre + "'")
        End If
        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_KardexInventario", _Where + " order by fdoc")
        _Ds.Tables.Add(_Tabla)
...
#Region "TC002 PERSONAL"
    ...
    Public Shared Function L_fnGrabarPersonal(ByRef numi As String, desc As String, direc As String, telef As String,
                                              ...
                                              eciv As String, plan As String, reloj As String, cbalmacen As Integer, precio As Integer, zona As Integer, camion As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@zona", zona))
        _listParam.Add(New Datos.DParametro("@cbalmacen", cbalmacen))
        _listParam.Add(New Datos.DParametro("@cbCamion", camion))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_fnModificarPersonal(ByRef numi As String, desc As String, direc As String, telef As String,
                                                  cat As String, sal As String, ci As String, obs As String, fnac As String,
                                                  fing As String, fret As String, fot As String, est As String,
                                                  eciv As String, plan As String, reloj As String, cbalmacen As Integer, precio As Integer, zona As Integer,
                                                 orden As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@precio", precio))
        _listParam.Add(New Datos.DParametro("@zona", zona))
        _listParam.Add(New Datos.DParametro("@orden", orden))
        _listParam.Add(New Datos.DParametro("@cbalmacen", cbalmacen))
        _listParam.Add(New Datos.DParametro("@cbCamion", camion))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
...
#Region "VR_GO_KardexPrestamosAgrupado"
    ...
    Public Shared Function L_prKardexPrestamoCanastillos(cliente As Integer, fechaI As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 18))
        _listParam.Add(New Datos.DParametro("@ccnumi", cliente))
        _listParam.Add(New Datos.DParametro("@ccultped", fechaI))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TC004", _listParam)
    ...
    Public Shared Function L_prObtenerSaldoAnterior(cliente As Integer, fechaI As String) As Integer
        ...
        If _Tabla.Rows.Count > 0 Then
            saldo = _Tabla.Rows(0).Item("total")
        Else
            saldo = 0
        End If
        Return saldo
    ...
    Public Shared Function L_prKardexPrestamoCanastillosChofer(cliente As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "MApasClientes"
    Public Shared Function L_prMapaCLienteGeneral() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prMapaCLienteGeneral1() As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 88))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TC004", _listParam)
...
#Region "TL001 Zona"
    ...
    Public Shared Function L_fnZonaGeneral2() As DataTable
        Dim _Tabla As DataTable
...
#Region "TI002 MOVIMIENTOS DE SALIDA DE PRODUCTOS PARA EL CHOFER BIOPETROL"
    ...
    Public Shared Function TraerTemporal(chofer As Integer) As DataTable
    ...
    Public Shared Function L_verificarCamionStock(cod As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@ibid", cod))
        _listParam.Add(New Datos.DParametro("@ibuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TM001SalidaChofer", _listParam)
        If _Tabla.Rows.Count > 0 Then
            _resultado = False
...
#Region "TI002 Movimientos"
    ...
    Public Shared Function L_fnStockDisponibleCajas(almacen As Integer, proveedor As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnPedidoSugerencia(mes As Integer, proveedor As Integer, anio As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@concep", proveedor))
        _listParam.Add(New Datos.DParametro("@iddc", anio))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
...
#Region "TCA001 Compra"
    ...
    Public Shared Function L_fnReporteCompra(prov As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@prov", prov))
        _listParam.Add(New Datos.DParametro("@fdoc", fechaI))
        _listParam.Add(New Datos.DParametro("@fvcred", fechaF))
...
#Region "TC005C  CATEGORIA"
    ...
    Public Shared Function L_prCategoriaGrabar(ByRef _canumi As String, _canombre As String, _cadesc As String, _caimg As String, _estado As Integer, ubicacion As Integer, detalle As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@caubi", ubicacion))
        _listParam.Add(New Datos.DParametro("@cadet", detalle))
    ...
    Public Shared Function L_prCategoriaModificar(ByRef _canumi As String, _canombre As String, _cadesc As String, _caimg As String, _caest As Integer, ubicacion As Integer, detalle As String) As Boolean
        Dim _resultado As Boolean
        '@canumi ,@canombre ,@cadesc ,@caimg ,@newFecha ,@newHora ,@cauact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prGeneralCamiones() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
    ...
    Public Shared Function L_prGeneralEstadoCamiones(fecha As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
    ...
    Public Shared Function L_prCamionGrabar(ByRef _canumi As String, placa As String, capacidad As Integer, _estado As Integer) As Boolean
        Dim _resultado As Boolean
        '@canumi ,@canombre ,@cadesc ,@caimg ,@newFecha ,@newHora ,@cauact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@cadesc", placa))
        _listParam.Add(New Datos.DParametro("@capacidad", capacidad))
        _listParam.Add(New Datos.DParametro("@caest", _estado))
        _listParam.Add(New Datos.DParametro("@cauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
    ...
    Public Shared Function L_prCamionModificar(ByRef _canumi As String, placa As String, capacidad As Integer, _caest As Integer) As Boolean
        ' Dim _resultado As Boolean
        '@canumi ,@canombre ,@cadesc ,@caimg ,@newFecha ,@newHora ,@cauact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "REPORTE DE VENTAS"
    Public Shared Function L_prListarPrevendedor() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function ReporteDespachoxProducto(idchofer As Integer, Estado As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 28))
        _listParam.Add(New Datos.DParametro("@distribuidor", idchofer))
        _listParam.Add(New Datos.DParametro("@categoria", Estado))
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    ...
    Public Shared Function L_prListarEfectividadVentas(fechaI As String, fechaF As String, zona As Integer, vendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 19))
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listParam.Add(New Datos.DParametro("@distribuidor", zona))
        _listParam.Add(New Datos.DParametro("@prevendedor", vendedor))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function
    Public Shared Function ReporteDespachoxProducto(idchofer As Integer, Estado As Integer, fechaI As String, fechaF As String) As DataTable
    ...
    Public Shared Function L_prListarReportePEdidosVsCosto(_fechaI As String, _FechaF As String, codCli As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@prevendedor", codCli))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_prListarReportePEdidosVsCostoUnVendedor(_fechaI As String, _FechaF As String, numiVendedor As String, codCli As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 11))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasDetallada(_fechaI As String, _FechaF As String, prov As Integer, cate As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 19))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@numi", prov))
        _listParam.Add(New Datos.DParametro("@categoria", cate))

        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetallada2(_fechaI As String, _FechaF As String, prov As Integer, cate As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 24))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetalladaProducto(_fechaI As String, _FechaF As String, prov As Integer, cate As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 21))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetalladaProducto2(_fechaI As String, _FechaF As String, prov As Integer, cate As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 25))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetalladaxMes2(mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, prov As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 23))
        _listParam.Add(New Datos.DParametro("@prevendedor", mes))
        _listParam.Add(New Datos.DParametro("@distribuidor", anio))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@Modulo", prov))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function

    Public Shared Function L_prReporteVentasDetalladaxMes(cliente As Integer, mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, prov As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 20))
        _listParam.Add(New Datos.DParametro("@numi", cliente))
        _listParam.Add(New Datos.DParametro("@prevendedor", mes))
        _listParam.Add(New Datos.DParametro("@distribuidor", anio))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
    ...
    Public Shared Function L_prReporteVentasDetalladaxMes2(mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, prov As Integer, dt As DataTable, cont As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 201))
        _listParam.Add(New Datos.DParametro("@numi", prov))
        _listParam.Add(New Datos.DParametro("@prevendedor", mes))
        _listParam.Add(New Datos.DParametro("@distribuidor", anio))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@productos", "", dt))
        _listParam.Add(New Datos.DParametro("@Modulo", cont))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetalladaxMesProducto(cliente As Integer, mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, prov As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 22))
        _listParam.Add(New Datos.DParametro("@numi", cliente))
    ...
    Public Shared Function L_prReporteVentasDetalladaxMesProducto3(mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, cliente As Integer, dt As DataTable, cont As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 221))
        _listParam.Add(New Datos.DParametro("@numi", cliente))
        _listParam.Add(New Datos.DParametro("@prevendedor", mes))
        _listParam.Add(New Datos.DParametro("@distribuidor", anio))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasDetalladaxMesProducto2(mes As Integer, anio As Integer, _fechaI As String, _FechaF As String, prov As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 26))
        _listParam.Add(New Datos.DParametro("@prevendedor", mes))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasTodosDistribuidores(_fechaI As String, _FechaF As String, ususario As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasUnoDistribuidor(_fechaI As String, _FechaF As String, _codPrevendedor As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasProductosInventario(_fechaI As String, _FechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 15))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasProductosInventarioMin(_fechaI As String, _FechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 16))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
...
#Region "VENTAS ESTADISTICOS"
    ...
    Public Shared Function L_fnObtenerVentasCOBRANZASEstadistico(_fechaI As String, _fechaF As String, _numiVendedor As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerCLientesSinMovimiento(_fechaI As String, _fechaF As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "VENTAS GRAFICAS"
    ...
    Public Shared Function L_prVentasGraficaListarRepartidores() As DataTable
        Dim _Tabla As DataTable
...
#End Region
    ...
    Public Shared Function L_fnReporteVentaAdmin(fechaI As String, fechaF As String, est As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@Fechadesde", fechaI))
        _listParam.Add(New Datos.DParametro("@Fechahasta", fechaF))
        _listParam.Add(New Datos.DParametro("@Producto", est))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("MAM_ReporteVentaAdministrativo", _listParam)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_fnGrabarPrecios2(dt As DataTable, dt1 As DataTable, dt2 As DataTable, fecha As String, hora As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 24))
        _listParam.Add(New Datos.DParametro("@TC007", "", dt))
        _listParam.Add(New Datos.DParametro("@TC0071", "", dt1))
        _listParam.Add(New Datos.DParametro("@TC0072", "", dt2))
        _listParam.Add(New Datos.DParametro("@fing", fecha))
        _listParam.Add(New Datos.DParametro("@cod", hora))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TC001", _listParam)
    ...
    Public Shared Function L_TraerHistrialPrecios(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
...
#End Region
    ...
    Public Shared Function L_SaldoMinimo(almacen As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 9))
        _listPalam.Add(New Datos.DParametro("@alm", almacen))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TI005", _listPalam)

        Return _Tabla
    End Function

    Public Shared Function ListarDespachoXChofer(chofer As Integer, estado As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 15))
        _listPalam.Add(New Datos.DParametro("@distribuidor", chofer))
        _listPalam.Add(New Datos.DParametro("@numi", estado))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listPalam)

        Return _Tabla
    End Function
    Public Shared Function ListarDespachoXcLIENTE(chofer As Integer, estado As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 18))
        _listPalam.Add(New Datos.DParametro("@distribuidor", chofer))
        _listPalam.Add(New Datos.DParametro("@numi", estado))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
    ...
    Public Shared Function TraerStockPrecio(canumi As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 17))
        _listPalam.Add(New Datos.DParametro("@numi", canumi))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TC001", _listPalam)

        Return _Tabla
    End Function

    Public Shared Function TListarMeses() As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 11))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_TI002", _listPalam)
...
#Region "Presupuesto"
    ...
    Public Shared Function GrabarPresupuesto(vendedor As Integer, mes As Integer, anio As Integer, fecha As String, hora As String, dt As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim _res As Boolean
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 9))
        _listPalam.Add(New Datos.DParametro("@codrepart", vendedor))
        _listPalam.Add(New Datos.DParametro("@mes", mes))
        _listPalam.Add(New Datos.DParametro("@anio", anio))
        _listPalam.Add(New Datos.DParametro("@fact", fecha))
        _listPalam.Add(New Datos.DParametro("@hact", hora))
        _listPalam.Add(New Datos.DParametro("@PS0011", "", dt))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function ModificarPresupuesto(cod As Integer, dt As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim _res As Boolean
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 12))
        _listPalam.Add(New Datos.DParametro("@codigo", cod))
        _listPalam.Add(New Datos.DParametro("@PS0011", "", dt))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function CargarPresupuestoTodos() As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 10))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function CargarDetallePresupuesto(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function CopiarDetallePresupuesto(cod As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 13))
        _listPalam.Add(New Datos.DParametro("@codigo", cod))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function TraerKPI1(mes As Integer, anio As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerKPI1detalle(mes As Integer, anio As Integer, vendedor As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 16))
        _listPalam.Add(New Datos.DParametro("@mes", mes))
        _listPalam.Add(New Datos.DParametro("@anio", anio))
        _listPalam.Add(New Datos.DParametro("@vend4", vendedor))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function TraerKPI2() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function TraerKPI21(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 171))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function TraerKPI2detalle(conciliacion As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 18))
        _listPalam.Add(New Datos.DParametro("@mesa", conciliacion))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
        ...
        Return _Tabla
    End Function
    Public Shared Function TraerKPI21detalle(chofer As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 181))
        _listPalam.Add(New Datos.DParametro("@mesa", chofer))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_go_CM001", _listPalam)
    ...
    Public Shared Function TraerKPIProducto1(fechaI As String, fechaF As String, top As Integer, orden As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 6))
        _listPalam.Add(New Datos.DParametro("@almacen", top))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listPalam.Add(New Datos.DParametro("@producto", orden))
        _listPalam.Add(New Datos.DParametro("@yduact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_VentasGraficas", _listPalam)


        Return _Tabla
    End Function

    Public Shared Function TraerKPIProducto2(fechaI As String, fechaF As String, top As Integer, orden As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerKPIProducto3(fechaI As String, fechaF As String, top As Integer, orden As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerKPIProducto4(fechaI As String, fechaF As String, top As Integer, orden As Integer, cliente As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 81))
        _listPalam.Add(New Datos.DParametro("@almacen", top))
        _listPalam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listPalam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listPalam.Add(New Datos.DParametro("@producto", orden))
        _listPalam.Add(New Datos.DParametro("@Mes", cliente))
        _listPalam.Add(New Datos.DParametro("@yduact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_VentasGraficas", _listPalam)
    ...
    Public Shared Function TraerKPICliente(fechaI As String, fechaF As String, top As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerKPIVendedor1(fechaI As String, fechaF As String, top As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function TraerKPIVendedor2(fechaI As String, fechaF As String, top As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "Ingresos Egresos"
    ...
    Public Shared Function L_prLibreriaClienteLGeneral(cod1 As Integer, cod2 As Integer) As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@ieTipo", cod1))
        _listParam.Add(New Datos.DParametro("@ieConcepto", cod2))
    ...
    Public Shared Function L_prIngresoEgresoGrabar(ByRef _ienumi As String, _ieFecha As String, _ieTipo As String,
                                           ...
                                           _ieconc As Integer, _NroCaja As Integer, _Sucursal As Integer, _idDevolucion As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@ieconc", _ieconc))
    ...
    Public Shared Function L_prListarChoferesIngresosEgresos() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ActualizarTIE001(ienumi As Integer, ccnumi As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@ienumi", ienumi))
        _listParam.Add(New Datos.DParametro("@ieconc", ccnumi))
        _listParam.Add(New Datos.DParametro("@ieuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TIE001", _listParam)
...
#Region "Facturacion"
    ...
    Public Shared Function VerificarNit(nit As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 37))
        _listParam.Add(New Datos.DParametro("@nit", nit))
    ...
    Public Shared Function TraerUltimoNit(nit As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function RegistrarNit(nit As String, rsocial As String, email As String, doc As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 38))
        _listParam.Add(New Datos.DParametro("@nit", nit))
        _listParam.Add(New Datos.DParametro("@razonsocial", rsocial))
        _listParam.Add(New Datos.DParametro("@email", email))
        _listParam.Add(New Datos.DParametro("@oanumi", doc))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    End Function

    Public Shared Function GrabarTFV001(pedido As Integer, fecha As String, factura As Integer, cuf As String,
                                        nit As String, cliente As String, subtotal As Double, total As Double, codcontrol As String, cufd As String, leyenda As String, nitemisor As String, printurl As String, siatid As String, siaturl As String, fact As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 39))
        _listParam.Add(New Datos.DParametro("@fvanumi", pedido))
        _listParam.Add(New Datos.DParametro("@fvafec", fecha))
        _listParam.Add(New Datos.DParametro("@fvanfac", factura))
        _listParam.Add(New Datos.DParametro("@fvaautoriz", cuf))
        _listParam.Add(New Datos.DParametro("@fvanitcli", nit))
        _listParam.Add(New Datos.DParametro("@fvadescli1", cliente))
        _listParam.Add(New Datos.DParametro("@fvastot", subtotal))
        _listParam.Add(New Datos.DParametro("@fvadebfis", 0))
        _listParam.Add(New Datos.DParametro("@fvaccont", ""))
        _listParam.Add(New Datos.DParametro("@fvafactint", fact))
        _listParam.Add(New Datos.DParametro("@fvaflim", fecha))
        _listParam.Add(New Datos.DParametro("@fvacodcon", codcontrol))
        _listParam.Add(New Datos.DParametro("@cufd", cufd))
        _listParam.Add(New Datos.DParametro("@fvaleyenda", leyenda))
        _listParam.Add(New Datos.DParametro("@fvanitemi", nitemisor))
        _listParam.Add(New Datos.DParametro("@fvaimpurl", printurl))
        _listParam.Add(New Datos.DParametro("@fvasiatid", siatid))
        _listParam.Add(New Datos.DParametro("@fvasiaturl", siaturl))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        If _Tabla.Rows.Count > 0 Then
            Return True
    ...
    Public Shared Function TraerFacturaID(nit As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 41))
        _listParam.Add(New Datos.DParametro("@nit", nit))
...
#Region "POLLOS"
    Public Shared Function TraerHojaRuta(zona As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 9))
        _listPalam.Add(New Datos.DParametro("@gr1", zona))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("MAM_ReporteComercial", _listPalam)

        Return _Tabla
    End Function

    Public Shared Function TraerPrecioPolloEntero() As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)
    ...
    Public Shared Function TraerPrecioPresas() As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)
    ...
    Public Shared Function TraerPrecioPP() As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)
    ...
    Public Shared Function GrabarHojaRuta(numi As Integer, zona As Integer, rep As Integer, fecha As String, horaS As String, horaL As String, peso As Double, dt As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim res As Boolean
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 1))
        _listPalam.Add(New Datos.DParametro("@codZona", zona))
        _listPalam.Add(New Datos.DParametro("@trnumi", numi))
        _listPalam.Add(New Datos.DParametro("@codRep", rep))
        _listPalam.Add(New Datos.DParametro("@fecha", fecha))
        _listPalam.Add(New Datos.DParametro("@horaS", horaS))
        _listPalam.Add(New Datos.DParametro("@horaL", horaL))
        _listPalam.Add(New Datos.DParametro("@pesoS", peso))
        _listPalam.Add(New Datos.DParametro("@THR0011", "", dt))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        ...
        Return res
    End Function
    Public Shared Function ModificarHojaRuta(numi As Integer, salida As Integer, zona As Integer, rep As Integer, fecha As String, horaS As String, horaL As String, peso As Double, dt As DataTable) As Boolean
        Dim _Tabla As DataTable
        Dim res As Boolean
        Dim _listPalam As New List(Of Datos.DParametro)
    ...
    Public Shared Function CargarHojaRutaTodos() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function CargarHojaRutaPendientesxDespacho() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerCabecera() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function traerRepartidorZona(codZona As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 5))
        _listPalam.Add(New Datos.DParametro("@trnumi", codZona))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
    ...
    Public Shared Function TraerSalidasPendientes(cod As Integer, salida As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 41))
        _listPalam.Add(New Datos.DParametro("@trnumi", cod))
        _listPalam.Add(New Datos.DParametro("@codRep", salida))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
    ...
    Public Shared Function TraerComanda(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ImprimirSalida(cod As Integer, Salida As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerPedidosPendientes(camion As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function TraerPedidosPendientes2(dt As DataTable, camion As Integer, salida As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 9))
        _listPalam.Add(New Datos.DParametro("@trnumi", camion))
        _listPalam.Add(New Datos.DParametro("@salida", salida))
        _listPalam.Add(New Datos.DParametro("@THR0011", "", dt))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
    ...
    Public Shared Function TraerPedidosPendientesNuevo(dt As DataTable) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function VerificarSalidaExistente(camion As Integer) As Boolean
        Dim res As Boolean
        Dim _Tabla As DataTable
    ...
    Public Shared Function VerificarSalidaExistenteDatos(camion As Integer) As DataTable
    ...
    Public Shared Function TraerDetalleSalida(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function TraerProductosSalida(dt As DataTable, cod As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listPalam.Add(New Datos.DParametro("@tipo", 11))
        _listPalam.Add(New Datos.DParametro("@trnumi", cod))
        _listPalam.Add(New Datos.DParametro("@THR00112", "", dt))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
    ...
    Public Shared Function cambiarestadoSalida(codHR As Integer, codSal As Integer, codConci As Integer, hora As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 12))
        _listPalam.Add(New Datos.DParametro("@trnumi", codHR))
        _listPalam.Add(New Datos.DParametro("@codZona", codSal))
        _listPalam.Add(New Datos.DParametro("@codRep", codConci))
        _listPalam.Add(New Datos.DParametro("@horaS", hora))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
    ...
    Public Shared Function TraerUltimaSalida(camion As Integer, fecha As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 14))
        _listPalam.Add(New Datos.DParametro("@trnumi", camion))
        _listPalam.Add(New Datos.DParametro("@fecha", fecha))
        _listPalam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_THR001", _listPalam)
