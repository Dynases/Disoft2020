...
#Region "TC001 Productos"
    ...
    Public Shared Function L_fnProductoPorCacod(cod As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnImportarInventario(_TI001 As DataTable) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@TI001", "", _TI001))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
...
#Region "TO005 Caja"
    ...
    Public Shared Function L_fnCobranzasGeneral() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnVerificarPagosPedidos(numi As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "PROFORMA"
    ...
    End Sub
#End Region
#Region "Generacion de Archivos CSV"
    Public Shared Function L_prGenerarCabfac(_fecha As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prGenerarDetfac(_fecha As String) As DataTable
        Dim _Tabla As DataTable
