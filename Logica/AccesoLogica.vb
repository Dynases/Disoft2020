...
#Region "TS002 Dosificacion"
    ...
    Public Shared Function L_fnListarAlmacenDosificacion() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObteneterDosificacion() As DataTable
        Dim _Tabla As DataTable
...
#End Region
    ...
    Public Shared Function L_fnReporteFacturados(Proveedor As Integer, Categoria As Integer, Marca As Integer, Atributo As Integer, Descripcion As String, FechaI As String, FechaF As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteFacturadosNotasVenta(Proveedor As Integer, Categoria As Integer, Marca As Integer, Atributo As Integer, Descripcion As String, FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteNotasVenta(Proveedor As Integer, Categoria As Integer, Marca As Integer, Atributo As Integer, Descripcion As String, FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
