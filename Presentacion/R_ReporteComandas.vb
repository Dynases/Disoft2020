...
Public Class R_ReporteComandas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReporteComandas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteComandas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteComandas = New R_ReporteComandas()
        rpt.Site = Me.Site
        Return rpt
    End Function
