...
Public Class R_VendedorUtilidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VendedorUtilidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VendedorUtilidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VendedorUtilidad = New R_VendedorUtilidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
