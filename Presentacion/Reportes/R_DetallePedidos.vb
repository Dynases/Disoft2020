...
Public Class R_DetallePedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_DetallePedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_DetallePedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_DetallePedidos = New R_DetallePedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
