...
Public Class R_HojadeRuta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_HojadeRuta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_HojadeRuta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_HojadeRuta = New R_HojadeRuta()
        rpt.Site = Me.Site
        Return rpt
    End Function
