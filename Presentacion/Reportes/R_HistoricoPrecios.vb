...
Public Class R_HistoricoPrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_HistoricoPrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_HistoricoPrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_HistoricoPrecios = New R_HistoricoPrecios()
        rpt.Site = Me.Site
        Return rpt
    End Function
