...
Public Class R_VendedorGanancia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VendedorGanancia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VendedorGanancia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VendedorGanancia = New R_VendedorGanancia()
        rpt.Site = Me.Site
        Return rpt
    End Function
