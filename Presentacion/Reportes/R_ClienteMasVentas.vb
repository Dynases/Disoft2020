...
Public Class R_ClienteMasVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ClienteMasVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ClienteMasVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ClienteMasVentas = New R_ClienteMasVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
