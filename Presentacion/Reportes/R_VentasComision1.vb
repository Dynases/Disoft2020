...
Public Class R_VentasComision1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasComision1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasComision1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasComision1 = New R_VentasComision1()
        rpt.Site = Me.Site
        Return rpt
    End Function
