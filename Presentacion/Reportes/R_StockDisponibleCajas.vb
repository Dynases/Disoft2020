...
Public Class R_StockDisponibleCajas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_StockDisponibleCajas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_StockDisponibleCajas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockDisponibleCajas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockDisponibleCajas = New R_StockDisponibleCajas()
        rpt.Site = Me.Site
        Return rpt
    End Function
