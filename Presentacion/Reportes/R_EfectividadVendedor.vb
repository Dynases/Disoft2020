...
Public Class R_EfectividadVendedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_EfectividadVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_EfectividadVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EfectividadVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EfectividadVendedor = New R_EfectividadVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
