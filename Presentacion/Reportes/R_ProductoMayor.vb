...
Public Class R_ProductoMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ProductoMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_orden_() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_ProductoMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ProductoMayor = New R_ProductoMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
