...
Public Class R_ComandaCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ComandaCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ComandaCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ComandaCliente = New R_ComandaCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
