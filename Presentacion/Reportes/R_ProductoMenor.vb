...
Public Class R_ProductoMenor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ProductoMenor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ProductoMenor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ProductoMenor = New R_ProductoMenor()
        rpt.Site = Me.Site
        Return rpt
    End Function
