...
Public Class R_ReporteCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReporteCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteCompra = New R_ReporteCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
