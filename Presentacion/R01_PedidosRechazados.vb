...
Public Class R01_PedidosRechazados
...
#Region "METODOS PRIVADOS"
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE PEDIDOS RECHAZADOS"
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            If swTipo.Value = True Then
                If global1 = 0 Then
                    objrep = New PedidosRechazados
                Else
                    objrep = New PedidosRechazados 'R_VentasComision1
                End If
            Else
                If global1 = 0 Then
            ...
            objrep.SetParameterValue("nombreDistribuidor", L_Usuario)
            objrep.SetParameterValue("FechaDocumento", tbFechaF.Value)
