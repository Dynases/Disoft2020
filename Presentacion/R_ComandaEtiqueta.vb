...
Public Class R_ComandaEtiqueta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ComandaEtiqueta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ComandaEtiqueta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ComandaEtiqueta = New R_ComandaEtiqueta()
        rpt.Site = Me.Site
        Return rpt
    End Function
