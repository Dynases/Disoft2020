...
#Region "Variable Globales"
    ...
    Dim _codConciliacion As Integer = 0
#End Region
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prIniciarTodo()
        ...
        _prCargarComboLibreria(cbConcepto, 17, 1)
...
#Region "METODOS SOBREESCRITOS"
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("cbdesc", False, "Chofer", 100))
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_prIngresoEgresoGrabar(tbcodigo.Text, dpFecha.Value, tipo, tbDescripcion.Text, cbConcepto.Value, tbMonto.Value, _codConciliacion,
                                                     1, _codChofer, "")
        If res Then
            Modificado = False
            _PMOLimpiar()
...
#Region "EVENTOS"
    ...
    Private Sub btConcepto_Click(sender As Object, e As EventArgs) Handles btConcepto.Click
        ...
        If L_prLibreriaGrabar(numi, "17", cbConcepto.Text, "") Then
            _prCargarComboLibreria(cbConcepto, "17", "1")
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        'If tbIdCaja.Text > 0 Then
        ToastNotification.Show(Me, "No puede Modificar este Ingreso/Egreso, ya se hizo cierre de caja, por favor primero elimine cierre de caja".ToUpper, My.Resources.WARNING, 5000, eToastGlowColor.Red, eToastPosition.TopCenter)
    ...
    Private Sub P_prAyudaChoferNuevo()
        ...
        listEstCeldas.Add(New Modelo.MCelda("oacnconc", True, "CONCILICACION", 150))
        ...
        If (bandera = True) Then
            ...
            _codConciliacion = Row.Cells("oacnconc").Value
