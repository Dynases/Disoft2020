...
#Region "Metodos y funciones indispensables"
    ...
    Private Sub P_prLimpiar()
        ...
        CbCiudad.Value = gs_Parametros(0).Item("syciudad")
        _Ciudad(CbCiudad.Text)
...
#End Region
    ...
    Private Sub J_Cb_Ciudad_ValueChanged(sender As Object, e As EventArgs) Handles CbCiudad.ValueChanged
        If CbCiudad.SelectedIndex >= 0 Then
            ...
            '    Case "SUCRE"
            '        GmMapa.Position = New PointLatLng(-19.047917, -65.259568)
            '    Case "TARIJA"
            '        GmMapa.Position = New PointLatLng(-21.533896, -64.734134)
            '    Case "POTOSI"
            '        GmMapa.Position = New PointLatLng(-19.589143, -65.753427)
            '    Case "BENI"
        ...
        End If
    End Sub
    Private Sub _Ciudad(ByRef ciu As String)
        Select Case ciu
            Case "SANTA CRUZ"
                GmMapa.Position = New PointLatLng(-17.782814, -63.182386)
            Case "LA PAZ"
