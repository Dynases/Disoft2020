...
Public Class PedidosRechazados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.PedidosRechazados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPedidosRechazados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PedidosRechazados = New PedidosRechazados()
        rpt.Site = Me.Site
        Return rpt
    End Function
