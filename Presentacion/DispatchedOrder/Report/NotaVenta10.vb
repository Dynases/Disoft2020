...
Public Class NotaVenta10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.NotaVenta10.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idPedido() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tgrupo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedNotaVenta10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaVenta10 = New NotaVenta10()
        rpt.Site = Me.Site
        Return rpt
    End Function
