...
Public Class R01_DetallePedidos
...
#Region "METODOS PRIVADOS"
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE DETALLE DE PEDIDOS"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosVendedor.Checked) Then
            _dt = L_prReporteDetallePedidoTodos(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), IIf(cbEstado.SelectedIndex = 0, ENEstadoPedido.DICTADO, ENEstadoPedido.ENTREGADO))
            Return
        End If
        If (checkUnaVendedor.Checked) Then
            If tbVendedor.Text <> String.Empty Then
                _dt = L_prReporteDetallePedidoVendedorUno(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbCodigoVendedor.Text, IIf(cbEstado.SelectedIndex = 0, ENEstadoPedido.DICTADO, ENEstadoPedido.ENTREGADO))
                Return
            Else
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New R_DetallePedidos
            ...
            objrep.SetParameterValue("Estado", (IIf(cbEstado.SelectedIndex = 0, ENEstadoPedido.DICTADO, ENEstadoPedido.ENTREGADO).ToString))
