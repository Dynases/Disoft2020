...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prCargarVenta()
        ...
        With grBuscador.RootTable.Columns("numi")
            .Width = 100
            .Caption = "CODIGO"
            .Visible = True

        End With
        With grBuscador.RootTable.Columns("placa")
            .Width = 300
            .Caption = "PLACA"
            .Visible = True
        End With
        ...
        With grBuscador.RootTable.Columns("capacidad")
            .Width = 350
            .Visible = True
            .Caption = "CAPACIDAD"
        End With
        ...
        '    .Visible = False
        'End With
        With grBuscador.RootTable.Columns("estado")
            .Width = 150
            .Visible = False
        End With
    ...
    Private Sub _prInhabiliitar()
        ...
        tbCapacidad.IsInputReadOnly = True
    ...
    Private Sub _prhabilitar()
        ...
        tbCapacidad.IsInputReadOnly = False
    ...
    Public Sub _prMostrarRegistro(_N As Integer)
        'a.canumi ,a.canombre ,a.cadesc ,a.caimg ,a.cafact,a.cahact,a.cauact
        With grBuscador
            tbcodigo.Text = .GetValue("numi")
            tbnombre.Text = .GetValue("placa")
            tbCapacidad.Text = .GetValue("capacidad")
            swEstado.Value = IIf(.GetValue("estado") = 0, False, True)
    ...
    Public Function _ValidarCampos() As Boolean
        If (tbnombre.Text.ToString.Length <= 0) Then
            ...
            ToastNotification.Show(Me, "Por Favor Inserte una placa".ToUpper, img, 2000, eToastGlowColor.Red, eToastPosition.BottomCenter)
            tbnombre.Select()
            Return False
    ...
    Public Sub _prGuardarModificado()
        ...
        If (Modificado = False) Then
            Res = L_prCamionModificar(tbcodigo.Text, tbnombre.Text, tbCapacidad.Value, IIf(swEstado.Value = False, 0, 1))
        Else
            Res = L_prCamionModificar(tbcodigo.Text, tbnombre.Text, tbCapacidad.Value, IIf(swEstado.Value = False, 0, 1))
        End If
    ...
    Public Sub _GuardarNuevo()
        ...
        Dim res As Boolean = L_prCamionGrabar(numi, tbnombre.Text, tbCapacidad.Value, IIf(swEstado.Value = False, 0, 1))
