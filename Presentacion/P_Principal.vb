...
#Region "Metodos Privados"
	...
	Private Sub _prCargarConfiguracionSistema()
		Try
			...
			If gi_CRM = 1 Then
				FP_CRM.Visible = True
				FP_Venta.Visible = True
			Else
				FP_CRM.Visible = False
				FP_Venta.Visible = False
			End If
...
#Region "Cofiguracion"
	...
	Private Sub btConfPrecio_Click(sender As Object, e As EventArgs) Handles btConfPrecio.Click
		...
		Dim frm As New F0_PreciosAlterno2
...
#Region "Inventario equipo"
	...
	Private Sub btInveMEKardexEquipo_Click(sender As Object, e As EventArgs) Handles btInveMEKardexEquipo.Click
		...
		frm.Titulo = "K A R D E X   D E   C A N A S T I L L O S"
		frm.Tipo = 1
		'frm._tab = tab3
		frm._modulo = FP_Inventario
		'Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
...
#Region "Compra"
	...
	Private Sub btnRepPrecios_Click(sender As Object, e As EventArgs) Handles btnRepPrecios.Click
		Dim frm As New R01_HistoricoPrecios
		frm._nameButton = btnRepPrecios.Name
		frm._modulo = FP_Configuracion
		frm.Show()
	End Sub
	...
	Private Sub btnCamiones_Click(sender As Object, e As EventArgs) Handles btnCamiones.Click
		Dim frm As New F0_Camion
		frm._nameButton = btnCamiones.Name
		frm._modulo = FP_Configuracion
		frm.Show()
