...
Public Class R_HojaRutaxChofer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_HojaRutaxChofer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_HojaRutaxChofer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_HojaRutaxChofer = New R_HojaRutaxChofer()
        rpt.Site = Me.Site
        Return rpt
    End Function
