...
Public Class R01_CanastilloChofer
...
#Region "METODOS PRIVADOS"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosVendedor.Checked) Then
            ...
            '    Return
            _dt = L_prKardexPrestamoCanastillosChofer(-1)
        End If
        If (checkUnaVendedor.Checked) Then
            '_dt = L_prListaPedidosUnVendedor(tbCodigoVendedor.Text)
            _dt = L_prKardexPrestamoCanastillosChofer(CInt(tbCodigoVendedor.Text))
            '    Return
        End If
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New R_PrestamoCanastillosChofer
