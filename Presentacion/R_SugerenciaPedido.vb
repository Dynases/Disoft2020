...
Public Class R_SugerenciaPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SugerenciaPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SugerenciaPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SugerenciaPedido = New R_SugerenciaPedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
