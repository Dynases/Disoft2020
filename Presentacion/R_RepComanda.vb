...
Public Class R_RepComanda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_RepComanda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_RepComanda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_RepComanda = New R_RepComanda()
        rpt.Site = Me.Site
        Return rpt
    End Function
